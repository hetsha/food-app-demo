...
__decorate([
    ...
    (0, swagger_1.ApiBody)({ schema: { properties: { phoneNumber: { example: '+919876543210' } } } }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Login/register with Google' }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Logout (revoke refresh token)' }),
